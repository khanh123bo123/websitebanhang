...
function toggleFilter() {
    ...
    if (filterForm.style.display === "none") {
        filterForm.style.display = "block"; // Hiển thị bộ lọc
        filterButton.textContent = "Bộ lọc"; // Thay đổi văn bản nút
    } else {
        filterForm.style.display = "none"; // Ẩn bộ lọc
        filterButton.textContent = "Bộ lọc"; // Thay đổi văn bản nút
    }
}
...
function renderProducts() {
    ...
    currentProducts.forEach((product) => {
        ...
        div.innerHTML = `
            ...
            <p>Năm: ${product.nămsảnxuất}</p>
            <p>Giá: $${product.giáxe}</p>
            <p>Tình trạng: ${product.tìnhtrạng}</p>
        `;
...
function filterProducts() {
    const brand = document.getElementById("hãng").value;
    const year = document.getElementById("năm sản xuất").value;
    const priceMin =
        parseFloat(document.getElementById("Giá thấp nhất").value) || 0;
    const priceMax =
        parseFloat(document.getElementById("Giá cao nhất").value) || Infinity;
    const condition = document.getElementById("Tình trạng").value;
