...
var productAdmin = function (category = null) {
    document.getElementById("product-admin").innerHTML = "";
    for (var i in product) {
        ...
        listproduct1 += "<td>" + data.category + "</td>";
        //  listproduct1+='';
        listproduct1 +=
...
var updateProduct = function (i) {
    ...
    document.getElementById("categoryd").value = k.category;
...
var submitUpdate = function (i) {
    ...
    k.category = document.getElementById("categoryd").value;
    // document.getElementById("idd").setAttribute("disabled","disabled");
    localStorage.setItem("listProduct", JSON.stringify(product));
    window.location.reload();
};
